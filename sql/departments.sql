...
('Администрация'),('Продажи'),('Программисты'), ('Закуп');

insert into emploers (name, departments_id) values
('Петя', 1),('Таня', 1),('Слава', 2), ('Миша', 2), ('Андрей', 3),('Паша', 3);
...
left join emploers  e on e.departments_id = d.id;
...
('Sergey', 'male'), ('Irina', 'female'), ('Ivan', 'male'),
('Nikita','male'), ('Olga', 'female');

select t1.name as female, t2.name as male
